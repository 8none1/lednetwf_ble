...
- Devices advertising as "iotb" prefix (including segment-based variants such as the "IOTBT6BA" USB corner lamp; colour and brightness are fully supported, and effect support is being mapped)
...
**Have an unsupported device?** Check out our [BLE Traffic Sniffing Guide](SNIFFING_BLE_TRAFFIC.md) to help us add support for your device!
